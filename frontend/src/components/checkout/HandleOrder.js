        ...
        <div className="main_container">
            <div className="container padding-bottom-3x mb-1">
                ...
                <div className="d-flex flex-wrap flex-md-nowrap justify-content-center justify-content-sm-between align-items-center">
                    ...
                    <div className="text-left text-sm-right"><a className="btn btn-outline-primary btn-rounded btn-sm" href="https://www.google.com/">View Order Details</a></div>
                </div>
            </div>
        </div>
    )
